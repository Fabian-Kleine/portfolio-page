        ...
        return (
            <>
                {renderedTechnologie.map((tech, i) =>
                    ...
                    }} key={i} className={"flex justify-center items-center cursor-default text-sm font-bold px-2 mr-2 mb-2 rounded-xl border-techBadge border-2 bg-techBadge bg-opacity-60"}>
        ...
        return (
            <>
                {renderedTechnologie.map((tech, i) =>
                    ...
                    }} className={"flex justify-center items-center gap-1 transition-shadow cursor-default mr-6 mb-6 py-2 px-4 bg-techBadge border-2 rounded-lg border-techBadge bg-opacity-60 hover:shadow-techBadge"}>
                        <img src={tech.icon} alt={tech.name} className="h-10" />
