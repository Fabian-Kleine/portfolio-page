                ...
                <div className="flex items-center flex-col pb-32">
                    ...
                    {filteredProjects.map((project, i) =>
                        <div key={i} className="bg-[#242424] mb-4 bg-opacity-60 border-[#242424] border-2 w-full xl:w-1/2 rounded-md p-2">
                            <a aria-label="Click to read more" title="Click to read more" href={!project.has_no_project_page ? ("/project/" + project.filename) : "javascript:void"} className={project.has_no_project_page ? "cursor-default": ""}>
