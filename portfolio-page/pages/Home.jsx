        ...
        <>
            <div className="relative h-[90vh] bg-pattern z-0">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full xl:w-fit 2xl:max-w-7xl">
                    ...
                    <p className="mx-8 mt-12 text-center text-sm xs:text-lg md:text-xl 2xl:text-2xl leading-7">I'm a student and selftaught Programmer focusing on web development but I'm ready for everything</p>
